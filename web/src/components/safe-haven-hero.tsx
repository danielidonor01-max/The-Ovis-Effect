...
const slides = ["Living room", "Master bedroom", "Kitchen", "City view"];

const ease = [0.22, 1, 0.36, 1] as [number, number, number, number];

export function SafeHavenHero({ house }: { house: House }) {
  ...
  return (
    <section className="pt-20 pb-4 sm:pt-24">
      <Container>
        {/* Tall, full-width image slider with text overlaid */}
        <div className="relative h-[78vh] min-h-[560px] w-full overflow-hidden rounded-3xl">
          {slides.map((label, idx) => (
            ...
            >
              ...
              {/* tiny per-slide caption, top-right */}
